...
union bno055_bus_config {
#if BNO055_BUS_I2C
	uint16_t i2c_addr;
#endif
};

typedef int (*bno055_bus_check_fn)(const struct device *bus,
				   const union bno055_bus_config *bus_config);
typedef int (*bno055_reg_read_fn)(const struct device *bus,
				  const union bno055_bus_config *bus_config,
				  uint8_t start, uint8_t *buf, int size);
typedef int (*bno055_reg_write_fn)(const struct device *bus,
				   const union bno055_bus_config *bus_config,
...
/* Kconfig configs */
#if defined CONFIG_BNO055_OPERATION_MODE_CONFIG
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_CONFIG
#elif defined CONFIG_BNO055_OPERATION_MODE_ACCONLY
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_ACCONLY
#elif defined CONFIG_BNO055_OPERATION_MODE_MAGONLY
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_MAGONLY
#elif defined CONFIG_BNO055_OPERATION_MODE_GYRONLY
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_GYRONLY
#elif defined CONFIG_BNO055_OPERATION_MODE_ACCMAG
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_ACCMAG
#elif defined CONFIG_BNO055_OPERATION_MODE_ACCGYRO
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_ACCGYRO
#elif defined CONFIG_BNO055_OPERATION_MODE_MAGGYRO
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_MAGGYRO
#elif defined CONFIG_BNO055_OPERATION_MODE_AMG
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_AMG
#elif defined CONFIG_BNO055_OPERATION_MODE_IMUPLUS
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_IMUPLUS
#elif defined CONFIG_BNO055_OPERATION_MODE_COMPASS
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_COMPASS
#elif defined CONFIG_BNO055_OPERATION_MODE_M4G
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_M4G
#elif defined CONFIG_BNO055_OPERATION_MODE_NDOF_FMC_OFF
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_NDOF_FMC_OFF
#elif defined CONFIG_BNO055_OPERATION_MODE_NDOF
#define BNO055_BEGIN_OPERATION_MODE BNO055_OPERATION_MODE_NDOF
#endif
